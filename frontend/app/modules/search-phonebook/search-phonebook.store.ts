...
export class SearchPhonebookStore {
  ...
  async searchCorpPhonebook(filter: string, exactSearch?: boolean) {
    const response = (await SDK.searchCorporatePhonebook({ filter, exactSearch })) as SearchCorpPhonebookResponse
