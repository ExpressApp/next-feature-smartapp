...
const ClientFeatures: FC = () => {
  return (
    <>
      ...
      <Subtitle>Чаты и сообщения</Subtitle>
      ...
      <StyledLink to="ios-pinch-to-zoom">
        <span className="material-icons">pinch</span>
        Зум смартапки на iOS
      </StyledLink>
      ...
      <StyledLink to="web-commands-pipeline">
